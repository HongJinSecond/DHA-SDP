    ...
    def write_result(self, result_path, method_name, presults: dict):
        ...
        if not os.path.exists(result_path):
            with  open(result_path,'w') as file:
                file.write(
                    "method,f1,auc,gmean,recall_at_20_percent_effort,effort_at_20_percent_LOC_recall,p_opt\n")
                file.flush()

        with open(result_path, "a+") as file:
            file.write(
                "{method_name},{f1},{auc},{gmean},{recall_at_20_percent_effort},{effort_at_20_percent_LOC_recall},{p_opt}\n".format(
                    method_name=method_name,
                    f1=presults["f1"], auc=presults["auc"],gmean=presults["gmean"],
